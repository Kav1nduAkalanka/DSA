...
void catalog_init(Catalog *catalog)
{
    ...
    catalog_add_game(catalog, 103, "Metal Gear Solid V", 19.99, 4.7, 5);
    ...
    catalog_add_game(catalog, 107, "Hollow Knight", 29.99, 5.0, 6.5);
    catalog_add_game(catalog, 108, "Arma 3", 29.99, 4.6, 12.5);
    catalog_add_game(catalog, 109, "Call of Duty", 59.99, 4.4, 50);
    catalog_add_game(catalog, 110, "Sniper Elite 5", 49.99, 4.3, 60);
    catalog_add_game(catalog, 111, "Insurgency", 29.99, 4.5, 20);
    catalog_add_game(catalog, 112, "Battlefield 1", 39.99, 4.7, 26.6);
    catalog_add_game(catalog, 113, "Spec Ops: The Line", 29.99, 4.6, 5.5);
    catalog_add_game(catalog, 114, "Tom Clancy's Ghost Recon", 49.99, 4.4, 8.6);
    ...
    catalog_add_game(catalog, 118, "Sleeping Dogs", 19.99, 4.6, 40);
